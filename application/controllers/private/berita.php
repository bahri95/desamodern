...
class Berita extends MY_Controller {
	...
	function index() {
		...
		//load
			$this->load->library('notification');
			$this->load->model('beritamodel');
			$data = $this->beritamodel->get_list_kategori_private();
			$this->smarty->assign("data", $data);
		...
		// set rules
			$this->notification->check_post('id_kategori', 'Kategori', 'required');
			...
			$this->notification->check_post('berita_berjalan', 'Berita berjalan', 'required');
			$this->notification->check_post('publish', 'publish', 'required');
			
		// run
			if ($this->notification->valid_input()) {
			// params
				$params = array('id_kategori' => $this->input->post('id_kategori'),              
					'judul' => $this->input->post('judul'),                    
					'content' => $this->input->post('content'),                    
					'keterangan_gambar' => $this->input->post('keterangan_gambar'),
					'berita_berjalan' => $this->input->post('berita_berjalan'),
					'publish' => $this->input->post('publish'),
					'keywords' => $this->input->post('keywords'),
					'user_id_create' => $this->id_user,
					'user_id_update' => $this->id_user);
		...
		// get asosiasi
			$datakategori = $this->beritamodel->get_list_kategori_private();
			$this->smarty->assign("datakategori", $datakategori);
		// parse url
			$this->smarty->assign("url_add", site_url("private/berita/add"));
			$this->smarty->assign("url_list", site_url("private/berita"));
		...
		// set rules
			...
			$this->notification->check_post('berita_berjalan', 'Berita berjalan', 'required');
			$this->notification->check_post('publish', 'publish', 'required');
			$this->notification->check_post('keywords', 'Keywords', 'required');
		// run
			if ($this->notification->valid_input()) {
			// params
				$params = array('id_kategori' => $this->input->post('id_kategori'),                  
