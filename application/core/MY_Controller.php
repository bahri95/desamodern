<?php 
    ...
    class MY_Controller extends CI_Controller {
        ...
        function _load_web_js() {
            ...
            $this->layout->load_javascript("themes/js/front/desmod/jquery.min.js");
        $this->layout->load_javascript("themes/js/front/desmod/bootstrap.min.js");
        $this->layout->load_javascript("themes/js/front/desmod/metisMenu.min.js");
        $this->layout->load_javascript("themes/js/front/desmod/jquery.mCustomScrollbar.concat.min.js");
        $this->layout->load_javascript("themes/js/front/desmod/wow.min.js");

        $this->layout->load_javascript("themes/js/front/desmod/jquery.newsTicker.js");
        $this->layout->load_javascript("themes/js/front/desmod/classie.js");
